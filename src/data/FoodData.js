export const FoodDiningData = [
  {
    id: 1,
    title: "Himachali Cuisine",
    description:
      "Savor the authentic flavors of Himachal Pradesh with traditional dishes like Dhaam (a festive platter of rice, dal, and curries), Tudkiya Bhath (spiced rice with lentils), and Chha Gosht (lamb cooked in yogurt gravy). Experience the unique taste of Siddu (steamed wheat bread stuffed with walnut or poppy seeds), Babru (Himachali kachori), and Madra (chickpeas in yogurt-based gravy). These dishes reflect the rich culinary heritage of the region, passed down through generations.",
    imageContent: "🍛",
    image: "/images/images2/Dal-proj-img-food-dham.jpg",
    alt: "Traditional Himachali thali with Dhaam, rice, dal, curries, and local breads.",
  },
  {
    id: 2,
    title: "Cafes & Bakeries",
    description:
      "Indulge in the cozy cafe culture of Dalhousie, where you can enjoy freshly baked pastries, wood-fired pizzas, and aromatic coffee while soaking in stunning mountain views. Popular spots like Cafe Dalhousie, Kwality Cafe, and Bon Appetit offer a perfect blend of continental and Indian cuisine. Try their signature cakes, hot chocolate, and freshly brewed coffee. The colonial-era architecture and warm ambiance make these cafes perfect for a relaxing afternoon.",
    imageContent: "☕",
    image: "/images/images2/Dal-proj-img-food-bakery.jpg",
    alt: "Cozy cafe in Dalhousie with mountain views, serving coffee and pastries.",
  },
  {
    id: 3,
    title: "Street Food Delights",
    description:
      "Explore the vibrant street food scene in Dalhousie's bustling markets. Sample local favorites like Aloo Tikki (spiced potato patties), Chole Bhature (spicy chickpeas with fried bread), and Momos (steamed dumplings) served with spicy chutney. Don't miss the freshly made Jalebis (crispy sweet spirals) and Gulab Jamuns from local sweet shops. The Gandhi Chowk market area is particularly famous for its evening food stalls offering a variety of snacks and quick bites.",
    imageContent: "🌭",
    image: "/images/images2/Dal-proj-img-food-streetfood.jpg",
    alt: "Street food stalls in Dalhousie market serving momos, tikkis, and local snacks.",
  },
  {
    id: 4,
    title: "Fine Dining Restaurants",
    description:
      "Experience elegant fine dining at Dalhousie's premium restaurants that offer panoramic views of the Himalayas. Establishments like Hotel Mountview, The Grand View, and Snow Valley Resort serve exquisite multi-cuisine menus featuring continental, Chinese, and authentic Himachali dishes. Enjoy candlelit dinners with stunning valley views, where skilled chefs prepare gourmet meals using locally-sourced ingredients. Perfect for special occasions and romantic evenings.",
    imageContent: "🍽️",
    image: "/images/images2/Dal-proj-img-food-restaurants.jpg",
    alt: "Elegant fine dining restaurant in Dalhousie with mountain views and candlelit tables.",
  },
];

export const localFoodData = [
  {
    id: 1,
